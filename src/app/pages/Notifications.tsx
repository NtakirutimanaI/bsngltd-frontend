                ...
                <div className="flex gap-3">
                    {unreadCount > 0 && (
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 text-orange-600 border border-orange-200 dark:border-orange-900/50 rounded-lg font-bold text-sm shadow-sm hover:bg-orange-50 transition-all"
                        >
                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                    <div className="p-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50/30 dark:bg-gray-800/20">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="bg-orange-600 text-white text-[10px] px-2 py-0.5 rounded-full font-bold">{notifications.length}</span>
                        </div>
                    </div>
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-gray-800">
                        {notifications.length === 0 ? (
                            ...
                            notifications.map((notification) => (
                                <div
                                    key={notification.id}
                                    className={`group relative p-5 transition-all hover:bg-gray-50 dark:hover:bg-gray-800/40 cursor-pointer ${!notification.read ? "bg-orange-50/20 dark:bg-orange-900/5" : ""
                                        }`}
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-3 mb-1">
                                                ...
                                                {!notification.read && (
                                                    <div className="h-2 w-2 bg-orange-600 rounded-full shadow-[0_0_8px_rgba(234,88,12,0.5)] animator-pulse" />
                                                )}
                                            </div>
