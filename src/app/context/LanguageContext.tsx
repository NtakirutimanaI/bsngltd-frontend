...
const translations: Translations = {
  ...
  websitePoweredBy: { en: 'This website powered by', rw: 'Urubuga rwakatunganijwe na', sw: 'Tovuti hii inaendeshwa na', fr: 'Ce site web est propulsé par' },
  ...
  expertSolutionsTailored: { en: 'Expert solutions tailored to your specific construction and real estate needs.', rw: 'Ibisubizo bya kinyamwuga bigenewe ibyo ukeneye mu bwubatsi.', sw: 'Suluhisho za kitaalam iliyoundwa kwa mahitaji yako maalum.', fr: 'Solutions expertes adaptées à vos besoins spécifiques.' },
  buildingExcellenceSince2010: { en: 'Building Excellence Since 2010', rw: 'Twubaka Indashyikirwa Kuva 2010', sw: 'Kujenga Ubora Tangu 2010', fr: 'Construire l\'Excellence Depuis 2010' },
  awardWinning: { en: 'Award Winning', rw: 'Ibihembo Byabaye', sw: 'Kushinda Tuzo', fr: 'Primé' },
  professionalStaff: { en: 'Professional Staff', rw: 'Abakozi b\'Abanyamwuga', sw: 'Wafanyakazi wa Kitaalamu', fr: 'Personnel Professionnel' },
  support24_7: { en: '24/7 Support', rw: 'Ubufasha Bwose 24/7', sw: 'Msaada wa 24/7', fr: 'Assistance 24/7' },
  whyPeople: { en: 'Why People', rw: 'Kuki Abantu', sw: 'Kwa Nini Watu', fr: 'Pourquoi les Gens' },
  chooseUs: { en: 'Choose Us', rw: 'Bahisamo Twe', sw: 'Wanatuchagua', fr: 'Nous Choisissent' },
  yearsExperience15: { en: '15+ Years Experience', rw: 'Imyaka 15+ y\'Ubunararibonye', sw: 'Miaka 15+ ya Uzoefu', fr: '15+ Années d\'Expérience' },
  yearsExperienceDesc: { en: 'Extensive experience in various construction projects across Rwanda and the region.', rw: 'Ubunararibonye bwagutse mu mishinga y\'ubwubatsi itandukanye.', sw: 'Uzoefu mkubwa katika miradi mbalimbali ya ujenzi.', fr: 'Vaste expérience dans divers projets de construction.' },
  professionalConstruction: { en: 'Professional Construction', rw: 'Ubwubatsi bwa Kinyamwuga', sw: 'Ujenzi wa Kitaalamu', fr: 'Construction Professionnelle' },
  professionalConstructionDesc2: { en: 'Using the latest technologies and best practices to ensure structural integrity and beauty.', rw: 'Gukoresha ikoranabuhanga rigezweho.', sw: 'Kutumia teknolojia za kisasa.', fr: 'Utiliser les dernières technologies.' },
  guaranteedQuality: { en: 'Guaranteed Quality', rw: 'Ubuziranenge Bwemejwe', sw: 'Ubora Uliohakikishiwa', fr: 'Qualité Garantie' },
  guaranteedQualityDesc: { en: 'We stand by our work and guarantee quality in every detail.', rw: 'Dushyigikira akazi kacu kandi twizeza ubuziranenge.', sw: 'Tunasimama kwa kazi yetu na kuhakikisha ubora.', fr: 'Nous soutenons notre travail et garantissons la qualité.' },
  ourProfessional: { en: 'Our Professional', rw: 'Inzobere Zacu', sw: 'Wataalamu Wetu', fr: 'Notre Professionnel' },
  team: { en: 'Team', rw: 'Ikipe', sw: 'Timu', fr: 'Équipe' },
  haveAnyQuery: { en: 'Have Any Query?', rw: 'Ufite Ikibazo?', sw: 'Una Swali Lolote?', fr: 'Avez-vous une Question ?' },
  contactUs: { en: 'Contact Us', rw: 'Twandikire', sw: 'Wasiliana Nasi', fr: 'Contactez-nous' },
  yourName: { en: 'Your Name', rw: 'Izina Ryawe', sw: 'Jina Lako', fr: 'Votre Nom' },
  yourEmail: { en: 'Your Email', rw: 'Imeli Yawe', sw: 'Barua Pepe Yako', fr: 'Votre Email' },
  whatIsThisAbout: { en: 'What is this about?', rw: 'Ibi bishaka kuvuga iki?', sw: 'Hii inahusu nini?', fr: 'De quoi s\'agit-il ?' },
  detailYourInquiry: { en: 'Detail your inquiry here...', rw: 'Sobanura ikibazo cyawe hano...', sw: 'Eleza swali lako hapa...', fr: 'Détaillez votre demande ici...' },
  modernAmenities: { en: 'Modern Amenities', rw: 'Ibyiza Bigezweho', sw: 'Vistawishi vya Kisasa', fr: 'Équipements Modernes' },
  secureLocation: { en: 'Secure Location', rw: 'Ahantu Hatekaniwe', sw: 'Eneo Salama', fr: 'Emplacement Sécurisé' },
  parkingAvailable: { en: 'Parking Available', rw: 'Parikingi Ihari', sw: 'Maegesho Yanapatikana', fr: 'Parking Disponible' },
  consultation24_7: { en: '24/7 Consultation', rw: 'Ubujyanama 24/7', sw: 'Ushauri wa 24/7', fr: 'Consultation 24/7' },
  contactAgent: { en: 'Contact Agent', rw: 'Vugisha Umuhuzabikorwa', sw: 'Wasiliana na Wakala', fr: 'Contacter l\'Agent' },
  switchCurrency: { en: 'Switch Currency', rw: 'Hindura Ifaranga', sw: 'Badilisha Sarafu', fr: 'Changer de Devise' },
  adjustFiltersOrSearch: { en: 'Try adjusting your filters or search terms.', rw: 'Gerageza guhindura ibyo ushaka.', sw: 'Jaribu kurekebisha vichungi vyako.', fr: 'Essayez d\'ajuster vos filtres.' },
  clearAllFilters: { en: 'Clear All Filters', rw: 'Siba Ibyashunguwe Byose', sw: 'Futa Vichungi Vyote', fr: 'Effacer Tous les Filtres' },
  servicesDesc1: { en: 'We provide a wide range of services to meet your development needs.', rw: 'Dutanga serivisi nyinshi kugira ngo duhuze n\'ibyo ukeneye mu iterambere.', sw: 'Tunatoa huduma mbalimbali kukidhi mahitaji yako ya maendeleo.', fr: 'Nous offrons une large gamme de services pour répondre à vos besoins de développement.' },
  servicesDesc2: { en: 'Our team of experts is dedicated to delivering excellence and innovation.', rw: 'Ikipe yacu y\'inzobere yiyemeje gutanga indashyikirwa no guhanga udushya.', sw: 'Timu yetu ya wataalamu imejitolea kutoa ubora na uvumbuzi.', fr: 'Notre équipe d\'experts se consacre à offrir l\'excellence et l\'innovation.' },
  callUsDirect247: { en: 'Call us direct 24/7 for a free consultation', rw: 'Duhamagare ako kanya 24/7 ku buntu', sw: 'Tupigie simu moja kwa moja 24/7 kwa bure', fr: 'Appelez-nous directement 24/7 pour une consultation gratuite' },
  learnMore: { en: 'Learn More', rw: 'Dushyikire Ibindi', sw: 'Jifunze Zaidi', fr: 'En Savoir Plus' },
  readyToBuild1: { en: 'Ready to', rw: 'Witeguye', sw: 'Tayari', fr: 'Prêt à' },
  readyToBuild2: { en: 'Build?', rw: 'Kubaka?', sw: 'Kujenga?', fr: 'Construire ?' },
  contactUsToday: { en: 'Contact us today to discuss your next project', rw: 'Twandikire uyu munsi kugira ngo tuganire', sw: 'Wasiliana nasi leo kujadili mradi wako unaofuata', fr: 'Contactez-nous aujourd\'hui pour discuter' },
  viewProperties: { en: 'View Properties', rw: 'Reba Imitungo', sw: 'Angalia Mali', fr: 'Voir les Propriétés' },
  tags: { en: 'Tags:', rw: 'Ibirango:', sw: 'Lebo:', fr: 'Mots-clés :' },
  quickSearch: { en: 'Quick Search', rw: 'Shakisha Vuba', sw: 'Utafutaji Haraka', fr: 'Recherche Rapide' },
  search: { en: 'Search', rw: 'Shakisha', sw: 'Tafuta', fr: 'Rechercher' },
  categories: { en: 'Categories', rw: 'Ibyiciro', sw: 'Vikundi', fr: 'Catégories' },
  ...
  chatbotGreetingResponse: { en: "Hi there! I'm the BSNG Assistant. I can tell you about our projects, prices, location, or services. What's on your mind?", rw: "Muraho! Ndi ubufasha bwa BSNG. Nshobora kubabwira ku mishinga yacu, ibiciro, aho turi, cyangwa serivisi. Mwifuza kumenya iki?", sw: "Habari! Mimi ni msaidizi wa BSNG. Ninaweza kukuambia kuhusu miradi yetu, bei, eneo letu, au huduma. Unataka kujua nini?", fr: "Salut ! Je suis l'assistant BSNG. Je peux vous parler de nos projets, de nos prix, de notre emplacement ou de nos services. Que désirez-vous savoir ?" },
  ...
  chatbotDefaultResponse: { en: "Thank you for your message. I'm BSNG's digital assistant. You can ask me about our construction services, properties, projects, company history, or our location!", rw: "Murakoze ku butumwa bwanyu. Ndi umufasha wa BSNG muri ubu buryo bwa digital. Mushobora kumbaza kuri serivisi zacu, imitungo, imishinga twakoze, amateka yacu, cyangwa aho twereherereye!", sw: "Asante kwa ujumbe wako. Mimi ni msaidizi wa digitali wa BSNG. Unaweza kuniuliza kuhusu huduma zetu, mali, miradi, historia ya kampuni, au eneo letu!", fr: "Merci pour votre message. Je suis l'assistant numérique de BSNG. Vous pouvez me poser des questions sur nos services, nos propriétés, nos projets, l'histoire de l'entreprise ou notre emplacement !" },
  ...
  chatbotServiceResponse: { en: "BSNG Ltd offers Residential & Commercial Construction, Property Development, Real Estate Sales, Rentals, Renovation, and Project Management.", rw: "BSNG Ltd itanga serivisi: Ubwubatsi, Iterambere ry'Imitungo, Kugurisha no Gukodesha Inzu, Ivugurura, n'Imiyoborere y'Imishinga.", sw: "BSNG Ltd inatoa huduma: Ujenzi, Maendeleo ya Mali, Mauzo ya Mali, Pangisha, Ukarabati, na Usimamizi wa Miradi.", fr: "BSNG Ltd propose : Construction, Développement Immobilier, Vente et Location de Biens, Rénovation et Gestion de Projet." },
  chatbotConstResponse: { en: "We specialize in both Residential and Commercial construction, focusing on high quality and structural integrity since 2005.", rw: "Twibanda ku bwubatsi bw'inzu zo guturamo n'iz'ubucuruzi, tukibanda ku buziranenge kuva mu 2005.", sw: "Tunajishughulisha na ujenzi wa makazi na biashara tangu 2005.", fr: "Nous nous spécialisons dans la construction résidentielle et commerciale depuis 2005." },
  chatbotRentResponse: { en: "We have quality rental properties in Kigali, including apartments and villas. Visit our 'Properties' page for details.", rw: "Dufite inzu nziza zo gukodesha muri Kigali. Reba ku rupapuro rw'Imitungo (Properties) kugira ngo urebe izihari.", sw: "Tuna mali nzuri za kupanga Kigali. Angalia ukurasa wa 'Mali' pili kupata maelezo zaidi.", fr: "Nous avons de belles propriétés à louer à Kigali. Consultez notre page 'Propriétés' pour plus de détails." },
  chatbotSellResponse: { en: "We sell houses and plots in Kibagabaga, Nyarutarama, and Kimihurura. All properties have legal titles (UPI).", rw: "Dugurisha inzu n'ibibanza i Kibagabaga, Nyarutarama, n'i Kimihurura. Byose bifite ibyangombwa by'amategeko (UPI).", sw: "Tunauza nyumba na viwanja Kibagabaga na Nyarutarama. Mali zote zina hati za kisheria.", fr: "Nous vendons des maisons et terrains à Kibagabaga et Nyarutarama. Tous les biens ont des titres légaux." },
  chatbotRenovResponse: { en: "Yes, we do professional renovations. We can transform your old space into a modern, functional environment.", rw: "Yego, dukora ivugurura ry'umwuga. Twahindura inzu yawe ishaje ikaba nshya kandi ifite isura nziza.", sw: "Ndiyo, tunafanya ukarabati wa kitaalamu.", fr: "Oui, nous effectuons des rénovations professionnelles." },
  chatbotContactResponse: { en: "Contact us at +250 737 213 060 or info.buildstronggenerations@gmail.com. Visit us at Kibagabaga, Kigali.", rw: "Mwatuvugisha kuri +250 737 213 060 cyangwa info.buildstronggenerations@gmail.com. Sura ibiro byacu i Kibagabaga.", sw: "Wasiliana nasi kwa +250 737 213 060 au barua pepe info.buildstronggenerations@gmail.com.", fr: "Contactez-nous au +250 737 213 060 ou info.buildstronggenerations@gmail.com." },
  chatbotHistoryResponse: { en: "BSNG Ltd was founded in 2005 and has completed over 250 projects. We've grown into a leading firm in Rwanda's construction sector.", rw: "BSNG Ltd yashinzwe mu 2005 kandi imaze gukora imishinga isaga 250. Twabaye ikigo cy'indashyikirwa mu bwubatsi mu Rwanda.", sw: "BSNG Ltd ilianzishwa mnamo 2005 na imekamilisha zaidi ya miradi 250.", fr: "BSNG Ltd a été fondée en 2005 et a réalisé plus de 250 projets." },
  chatbotVisionResponse: { en: "Our vision is to be the most trusted construction company in the region, building for future generations with excellence and integrity.", rw: "Icyerekezo cyacu ni ukuba ikigo cyizewe kurusha ibindi mu karere, twubakira ejo hazaza neza.", sw: "Maono yetu ni kuwa kampuni ya ujenzi inayoaminika zaidi katika kanda.", fr: "Notre vision est d'être l'entreprise de construction la plus fiable de la région." },
  chatbotProjectsResponse: { en: "Some of our key projects include Kigali Heights Tower, Green Valley Estates, and the City Center Complex.", rw: "Imishinga yacu y'ingenzi harimo Kigali Heights Tower, Green Valley Estates, na City Center Complex.", sw: "Baadhi ya miradi yetu ni pamoja na Kigali Heights Tower na Green Valley Estates.", fr: "Certains de nos projets clés incluent la Kigali Heights Tower et Green Valley Estates." },
  chatbotPricingResponse: { en: "Pricing varies by project. Houses start from 85M RWF for apartments to 250M+ RWF for luxury villas. Contact us for a specific quote.", rw: "Ibiciro biratandukana. Inzu zitangirira kuri miliyoni 85 kugeza kuri miliyoni 250+. Twandikire tuguhe igiciro nyacyo.", sw: "Bei zinatofautiana. Nyumba zinaanza kutoka milioni 85 RWF. Wasiliana nasi kwa nukuu ya mradi wako.", fr: "Les prix varient selon le projet. Les maisons commencent à partir de 85M RWF. Contactez-nous pour un devis." },
  chatbotTeamResponse: { en: "Our team includes over 150 skilled professionals, including expert engineers, architects, and site managers.", rw: "Ikipe yacu igizwe n'abakozi b'inzobere barenga 150, harimo ba enjeniyeri, abahanga mu bishushanyo, n'abashinzwe imishinga.", sw: "Timu yetu ina wataalamu zaidi ya 150 wenye ujuzi.", fr: "Notre équipe comprend plus de 150 professionnels qualifiés." },
  ourHistoryChat: { en: "Our History", rw: "Amateka Yacu", sw: "Historia Yetu", fr: "Notre Histoire" },
  viewProjectsChat: { en: "Our Projects", rw: "Imishinga Yacu", sw: "Miradi Yetu", fr: "Nos Projets" },
  perMonthShort: { en: 'mo', rw: 'kwezi', sw: 'mwezi', fr: 'mois' },
  sqftShort: { en: 'sqft', rw: 'kare', sw: 'sqft', fr: 'pi²' },
};
