...
const initialTeam = [
  { id: 1, fullName: 'Jean Pierre Nkurunziza', role: 'Lead Architect', imageUrl: 'img/team-1.jpg', facebookUrl: '#', twitterUrl: '#', instagramUrl: '#', linkedinUrl: '#' },
  { id: 2, fullName: 'Emmanuel Habimana', role: 'Site Manager', imageUrl: 'img/team-2.jpg', facebookUrl: '#', twitterUrl: '#', instagramUrl: '#', linkedinUrl: '#' },
  { id: 3, fullName: 'Diane Uwase', role: 'Civil Engineer', imageUrl: 'img/team-3.jpg', facebookUrl: '#', twitterUrl: '#', instagramUrl: '#', linkedinUrl: '#' },
  { id: 4, fullName: 'Eric Mugisha', role: 'Property Manager', imageUrl: 'img/team-4.jpg', facebookUrl: '#', twitterUrl: '#', instagramUrl: '#', linkedinUrl: '#' },
];
...
export default function Team() {
      ...
      .then(data => {
        if (data && data.length > 0) {
          setTeamMembers(data.map(m => ({
            ...m,
            imageUrl: m.imageUrl || 'img/team-1.jpg',
  ...
  return (
        ...
        <div className="container py-5">
            <div className="row g-3 align-items-center">
                <div className="col-lg-6 text-center text-lg-start">
                    <h1 className="display-1 mb-0 slideInLeft">Our Team</h1>
                </div>
                <div className="col-lg-6 slideInRight">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb justify-content-center justify-content-lg-end mb-0">
                            ...
                            <li className="breadcrumb-item text-secondary active" aria-current="page">Our Team</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div className="container-fluid py-5">
        <div className="container py-5">
            <div className="text-center mb-5 fadeIn" data-wow-delay="0.1s">
                <h1>Meet Our <span className="text-uppercase text-primary bg-light px-2">Professional Team</span></h1>
                <p className="mt-3">Behind every successful BSNG project is a dedicated team of experts committed to excellence in construction, design, and client service.</p>
            </div>
            <div className="row g-4">
                {teamMembers.map((member, index) => (
                    <div key={member.id} className="col-md-6 col-lg-3 fadeIn" data-wow-delay={`0.${(index%4)*2 + 1}s`}>
                        <div className="team-item position-relative overflow-hidden">
                            <img className="img-fluid w-100" src={member.imageUrl} alt={member.role} />
                            <div className="team-overlay">
                                <small className="mb-2">{member.role}</small>
                                <h4 className="lh-base text-light">{member.fullName}</h4>
                                <div className="d-flex justify-content-center">
                                    <a className="btn btn-outline-primary btn-sm-square border-2 me-2" href={member.facebookUrl}>
                                        <i className="fab fa-facebook-f"></i>
                                    </a>
                                    <a className="btn btn-outline-primary btn-sm-square border-2 me-2" href={member.twitterUrl}>
                                        <i className="fab fa-twitter"></i>
                                    </a>
                                    <a className="btn btn-outline-primary btn-sm-square border-2 me-2" href={member.instagramUrl}>
                                        <i className="fab fa-instagram"></i>
                                    </a>
                                    <a className="btn btn-outline-primary btn-sm-square border-2" href={member.linkedinUrl}>
    ...
    <div className="container-fluid py-5 bg-light">
        <div className="container py-5">
            <div className="text-center mb-5 fadeIn" data-wow-delay="0.1s">
                <h1>Our Team's <span className="text-uppercase text-primary bg-light px-2">Core Values</span></h1>
            </div>
            <div className="row g-4">
                <div className="col-md-6 col-lg-3 text-center fadeIn" data-wow-delay="0.1s">
                    <i className="fa fa-award fa-4x text-primary mb-3"></i>
                    <h5>Excellence</h5>
                    <p>We hold ourselves to the highest standards in every task, from planning to project delivery.</p>
                </div>
                <div className="col-md-6 col-lg-3 text-center fadeIn" data-wow-delay="0.3s">
                    <i className="fa fa-users fa-4x text-primary mb-3"></i>
                    <h5>Teamwork</h5>
                    <p>We collaborate closely as a team and with our clients to ensure every project is a shared success.</p>
                </div>
                <div className="col-md-6 col-lg-3 text-center fadeIn" data-wow-delay="0.5s">
                    <i className="fa fa-handshake fa-4x text-primary mb-3"></i>
                    <h5>Integrity</h5>
                    <p>We operate with full transparency — honest pricing, honest timelines, and honest communication.</p>
                </div>
                <div className="col-md-6 col-lg-3 text-center fadeIn" data-wow-delay="0.7s">
                    <i className="fa fa-lightbulb fa-4x text-primary mb-3"></i>
                    <h5>Innovation</h5>
                    <p>We constantly seek better ways to design, build, and serve — staying ahead in Rwanda's construction sector.</p>
                </div>
            </div>
        </div>
    </div>
