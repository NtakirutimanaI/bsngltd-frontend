...
const initialTestimonials = [
  { id: 1, serviceName: 'Plot Sales', content: 'Aliqu diam amet diam et eos labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo justo et tempor eirmod magna dolore erat amet', clientName: 'Boris Johnson', imageUrl: 'img/testimonial-1.jpg' },
  { id: 2, serviceName: 'Client Satisfaction', content: 'Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo justo et tempor eirmod magna dolore erat amet', clientName: 'Alexander Bell', imageUrl: 'img/testimonial-2.jpg' },
  { id: 3, serviceName: 'Property Rental', content: 'Diam amet diam et eos labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo justo et tempor eirmod magna dolore erat amet', clientName: 'Bradley Gordon', imageUrl: 'img/testimonial-3.jpg' },
];
          ...
          <div className="container py-5">
              <div className="row g-3 align-items-center">
                  <div className="col-lg-6 text-center text-lg-start">
                      <h1 className="display-1 mb-0 slideInLeft">Testimonial</h1>
                  </div>
                  <div className="col-lg-6 slideInRight">
                      <nav aria-label="breadcrumb">
                          <ol className="breadcrumb justify-content-center justify-content-lg-end mb-0">
                              ...
                              <li className="breadcrumb-item text-secondary active" aria-current="page">Testimonial</li>
                          </ol>
                      </nav>
                  </div>
              </div>
