...
const initialHomeProjects = [
  ...
  { id: 3, title: 'Master Bedroom', category: 'House Construction', image: 'img/project-3.jpg' },
  { id: 4, title: 'Living Room', category: 'Interior Design', image: 'img/project-4.jpg' },
  { id: 5, title: 'Residential Villa', category: 'New Build', image: 'img/project-5.jpg' },
  { id: 6, title: 'Full Renovation', category: 'Renovation', image: 'img/project-6.jpg' },
];
            ...
            <div className="row g-5 align-items-center mb-5">
                ...
                <div className="col-lg-6">
                    <div className="owl-carousel header-carousel fadeIn">
                        <img className="img-fluid" src={cmsData.hero?.slider_1 || "img/hero-slider-1.jpg"} alt="BSNG Construction Project" />
                        <img className="img-fluid" src={cmsData.hero?.slider_2 || "img/hero-slider-2.jpg"} alt="BSNG Plot Sales" />
                        <img className="img-fluid" src={cmsData.hero?.slider_3 || "img/hero-slider-3.jpg"} alt="BSNG Renovation" />
                    </div>
                </div>
            </div>
                ...
                <div className="col-lg-6">
                    <div className="row">
                        <div className="col-6 fadeIn" data-wow-delay="0.1s">
                            <img className="img-fluid" src={cmsData.about?.image_1 || "img/about-1.jpg"} alt="BSNG Construction Site" />
                        </div>
                        <div className="col-6 fadeIn" data-wow-delay="0.3s">
                            <img className="img-fluid h-75" src={cmsData.about?.image_2 || "img/about-2.jpg"} alt="BSNG Building Works" />
